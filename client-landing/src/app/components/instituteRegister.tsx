...
//       setRegisterInstituteData({ ...registerInstituteData, instituteImage: files[0] as any });
//     } else {
...
//             className="w-full text-sm p-2 border-b border-indigo-500 text-indigo-700 outline-none focus:bg-gray-100 transition"
//           >
//             <option value="">Select PAN Number (optional)</option>
//             <option value="PAN1234">PAN1234</option>
//             <option value="PAN5678">PAN5678</option>
//           </select>
...
//             className="w-full text-sm p-2 border-b border-indigo-500 text-indigo-700 outline-none focus:bg-gray-100 transition"
//           >
//             <option value="">Select VAT Number (optional)</option>
//             <option value="VAT1234">VAT1234</option>
//             <option value="VAT5678">VAT5678</option>
//           </select>

//           <div>
//             <label className="block text-sm font-medium text-indigo-700 mb-1">Institute Cover Image</label>
//             <input
//               type="file"
//               name="instituteImage"
//               accept="image/*"
...
function InstituteRegister() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (result?.success) {
      toast.success(result.message);
      router.push(`/institute/${result.instituteNumber}/courses`);
    } else {
      toast.error(result.message || 'Something went wrong!');
    }
  };
