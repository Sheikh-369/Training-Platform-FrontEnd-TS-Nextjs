// components/modals/DeleteStudentModal.tsx
'use client'
import React from "react";
import { useAppDispatch } from "@/lib/store/hooks";
import { deleteStudent } from "@/lib/store/owner/student/student-slice";
...
const DeleteStudentModal: React.FC<DeleteStudentModalProps> = ({
  ...
  const handleDelete = () => {
    dispatch(deleteStudent(instituteNumber,Number(student.id)));
    closeModal();
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-md p-6 bg-white dark:bg-gray-800 rounded-lg shadow-xl">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6">
          Are you sure you want to delete the student "<strong>{student.studentName}</strong>"? This action cannot be undone.
        </p>
