...
import {
  clearUserInstituteRole,
  fetchUserInstitutes,
} from "@/lib/store/user-institute-role/user-institute-role-slice";
...
export default function MyInstitutes() {
  ...
  useEffect(() => {
    // dispatch(clearUserInstituteRole()); // Always clear old data
...
//   const dispatch = useAppDispatch();
//   const { institutes, status } = useAppSelector((state) => state.userRole);
//   const { user } = useAuth(); // Make sure user?.id is your studentId if student
...
//                 ? `/${role}/dashboard?instituteNumber=${instituteNumber}&studentId=${userId}`
//                 : `/${role}/dashboard?instituteNumber=${instituteNumber}`;
