  ...
  if (status === Status.SUCCESS && instituteCourse.length > 0) {
    ...
    return (
      <div className="min-h-screen bg-sky-100">
        {/* Hero Section */}
        <div className="bg-green-200 shadow-md py-8 px-4 md:px-12 flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
          {instituteImage ? (
            <img
              src={instituteImage}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {instituteCourse.map((course) => (
              <div
                ...
                className="bg-sky-200 rounded-lg shadow hover:shadow-lg transition-all duration-200 p-4 flex flex-col"
              >
                {/* Thumbnail Image */}
