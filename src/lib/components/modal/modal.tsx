...
import { ICategoryDataModal } from "@/lib/store/institute/category/categorySliceTypes"
...
const Modal:React.FC<ICloseModal>=({closeModal})=>{
    ...
    const [categoryData,setCategoryData]=useState<ICategoryDataModal>({
        categoryName:"",
        categoryDescription:""
    })
  ...
  <div className="relative w-full max-w-md p-6 bg-white dark:bg-gray-800 rounded-lg shadow-xl">
    ...
    <div className="space-y-4">
      <div>
        ...
        <input onChange={handleCategoryChange} type="text" name="categoryName" id="website_url" className="w-full mt-1 p-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500" placeholder="Category name..." required />
      </div>
      <div>
      ...
      <div className="flex justify-end gap-3">
        <button onClick={closeModal} id="cancelButton" className="px-4 py-2 text-sm font-medium text-white-500 bg-red-500 border border-gray-300 rounded-md hover:bg-gray-50 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600">
          Cancel
        </button>
